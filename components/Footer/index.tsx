...
export default function Footer() {
  return (
    <footer className="bg-[#3E2E2E] text-white py-8 px-4">
        ...
        <div>
          ...
          <div className="mt-6 space-y-2">
            <div className="flex items-center">
              <img src="/email-icon.svg" alt="Email Icon" className="mr-2" /> {/* Use an appropriate email icon image here */}
              <a href="mailto:info@inspire.org" className="hover:underline">info@inspire.org</a>
            </div>
            <div className="flex items-center">
              <img src="/phone-icon.svg" alt="Phone Icon" className="mr-2" /> {/* Use an appropriate phone icon image here */}
              <a href="tel:+9126123456" className="hover:underline">9126123456</a>
            </div>
          </div>
        </div>
