...
const Shortlist = () => {
  ...
  return (
    <div className="bg-[#fbf9ed]">
      {/* Header */}
      <header className="relative h-[50vh] w-full bg-[#e29074] py-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="mt-32 text-4xl font-serif mb-4 text-white text-center">Your shortlist</h1>
          <p className="text-white text-center">
            Add speakers to your shortlist to see them all in one place. Once your list is complete, you can send it to yourself and <br />your team, or get in touch to enquire about speaker availability.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <div className="text-xl text-[#e29074]">My Shortlist</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {speakers.map((speaker) => (
            <div key={speaker._id} className="w-64 h-80 m-4 p-4 bg-white rounded-lg shadow-md flex flex-col items-center justify-center transition-transform transform hover:scale-105">
              <img src={speaker.imageUrl} alt={speaker.name} className="w-full h-48 object-cover rounded-t-md" />
              <h2 className="text-lg font-bold mt-2 text-[#14394b]">{speaker.name}</h2>
          ...
          <Link href="/findaspeaker">
            <div className="w-64 h-80 m-4 p-4 bg-white rounded-lg shadow-md flex flex-col items-center justify-center transition-transform transform hover:scale-105">
              <div className="w-16 h-16 bg-[#e29074] rounded-full flex items-center justify-center hover:bg-[#d27865] transition-colors">
        ...
        {showDeleteModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-16 rounded-lg max-w-md">
              <h2 className="text-3xl font-serif text-[#e29074] mb-6">
                Are you sure you want to delete your shortlist?
              </h2>
              <p className="text-gray-600 mb-6">
                This action cannot be undone. All speakers will be removed from your shortlist.
              </p>
              <div className="flex justify-between">
                <button
                  onClick={confirmDelete}
                  className="px-4 py-2 bg-[#e29074] text-white rounded flex items-center"
                >
